...
public class ShowMapActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        View mainview = inflater.inflate(R.layout.activity_show_map, null);
        ...
        tv_msg = mainview.findViewById(R.id.msg);
        ...
        mFloorListAdapter = new BaseStripAdapter(ShowMapActivity.this);
